...
<html lang="en">
  ...
  <body>
	...
	<div class="col-md-6 col-md-offset-3 berhasil">Login berhasil.<br>Selamat datang, <strong><?php  session_start();  $username = $_SESSION['username']; echo $username;?> !<br><a href="home.php"><button class="utama">Menuju Halaman Utama</div></a>
